...
EMAIL_HOST = 'smtp.gmail.com'  # Gmail SMTP server host
EMAIL_PORT = 465  # Gmail SMTP server port
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'prasadgullapalli16@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'prasad475330'